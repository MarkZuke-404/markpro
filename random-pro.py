...
try:
    ...
    os.system('clear')
    xox('\n\t\x1b[93;1m  PLZ ON YOUR DATA CONNECTION :(\n\n')
    sys.exit()
...
def main():
    ...
    print ''
    print '\x1b[97;1m  [1] PUBLIC AND FOLLOWER CLONING \x1b[92;1m(Login)'
    print '\x1b[97;1m  [2] 2004 RANDOM OLD ID CLONING \x1b[92;1m(W-Login)'
    print '\x1b[97;1m  [3] 2009 RANDOM OLD ID CLONING \x1b[92;1m(W-Login)'
    print '\x1b[97;1m  [4] CONTACT TO OWNER'
    print '\x1b[97;1m  [0] EXIT'
    print ''
    log_sel()


def log_sel():
    sel = raw_input('\x1b[98;1m  CHOOSE: \x1b[92;1m')
    if sel == '':
        ...
        acc2009()
    elif sel == '4' and sel == '04' and sel == 'J' or sel == 'j':
...
def acc2004():
    ...
    print ''
    print ''
    print 'This Is Not Available Yet Plz Wait For Update'
    print ''
    raw_input('Return To Main Menu')
    main()
...
def menu():
    ...
    logo()
    print ''
    print '\x1b[98;1mHELLOO   :      \x1b[98;1m' + xn
    print '\x1b[98;1mREGION   :      \x1b[98;1m' + loc
    print '\x1b[98;1mYOUR IP  :      \x1b[98;1m' + ip
    print ''
    print ''
    print '\x1b[98;1m  [1] CRACK WITH AUTO PASS'
    print '\x1b[98;1m  [2] CRACK WITH DIGIT PASS'
...
def crack1():
    ...
    logo()
    print ''
    print '\t\x1b[98;1m CRACK WITH AUTO PASS'
    print ''
    print '\x1b[98;1m  [1] CRACK PUBLIC ID'
    print '\x1b[98;1m  [2] CRACK FOLLOWERS'
    print '\x1b[98;1m  [3] CRACK FILE'
    print ''
    crack_select1()


def crack_select1():
    select = raw_input('\x1b[98;1m  CHOOSE : ')
    id = []
    oks = []
    cps = []
    if select == '1':
        ...
        logo()
        print ''
        print '\t\x1b[98;1m MULTI PUBLIC ID COINING '
        print ''
        
        try:
            id_limit = int(raw_input('\x1b[98;1m PUT HOW MANY IDS YOU WANT?? '))
            print ''
        except:
            id_limit = 1
        ...
        for t in range(id_limit):
            t += 1
            idt = raw_input('\x1b[97;1m  INPUT PUBLIC ID (\x1b[92;1m%s\x1b[97;1m) : \x1b[92;1m' % t)
            ...
            try:
                ...
                print '\x1b[91;1m  THIS ACC FRIENDLIST IS NOT PUBLIC'

            print '\x1b[92;1m  TOTAL IDS  : \x1b[0;92m%s\x1b[0;97m' % len(id)
        ...
        try:
            id_limit = int(raw_input('\x1b[93;1m PUT HOW MANY IDS YOU WANT? '))
            print ''
        except:
            id_limit = 1
        ...
        for t in range(id_limit):
            t += 1
            idt = raw_input('\x1b[97;1m  INPUT FOLLOWER ID (\x1b[92;1m%s\x1b[97;1m) : \x1b[92;1m' % t)
            ...
            try:
                ...
                print '\x1b[91;1m  THIS ACC FOLLOWER IS NOT PUBLIC'
    ...
    logo()
    print ''
    print '\x1b[97;1m  TOTAL IDS : \x1b[92;1m' + str(len(id))
    print '\x1b[97;1m  BRUTE HAS BEEN STARTED\x1b[0m'
    print '\x1b[97;1m  AEROPLANE MODE EVERY 10 MINT.'
    linex()
    ...
    linex()
    print ''
    print '\x1b[98;1m THE PROCESS HAS BEEN COMPLETED'
    print '\x1b[98;1m TOTAL \x1b[92;1mOK\x1b[92;1m/\x1b[98;1mCP: ' + str(len(oks)) + '/' + str(len(cps))
    print ''
    linex()
    print ''
...
def crack():
    ...
    logo()
    print ''
    print '\t\x1b[98;1m  DIGIT PASS CRACKING'
    print ''
    print '\x1b[98;1m  [1] CRACK PUBLIC ID'
    print '\x1b[98;1m  [2] CRACK FOLLOWERS'
    print '\x1b[98;1m  [3] CRACK FILE'
...
def crack_select():
    ...
    if select == '1':
        ...
        for t in range(id_limit):
            ...
            try:
                ...
                print '\x1b[91;1m  THIS ACC FRIEDLIST IS NOT PUBLIC'
    ...
    logo()
    print ''
    print '\x1b[98;1m  TOTAL IDS : \x1b[92;1m' + str(len(id))
    print '\x1b[98;1m  BRUTE HAS BEEN STARTED\x1b[0m'
    print '\x1b[98;1m  AEROPLANE MODE EVERY 10 MINT.'
    linex()
    ...
    print ''
    print '\x1b[98;1m THE PROCESS HAS BEEN COMPLETED'
    print '\x1b[98;1m TOTAL \x1b[92;1mOK\x1b[98;1m/\x1b[91;1mCP: ' + str(len(oks)) + '/' + str(len(cps))
    print ''
    linex()
    print ''
    raw_input('\x1b[98;1m PRESS ENTER TO BACK ')
